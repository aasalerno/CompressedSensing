...
% March 9, 2015, Matthijs: I'm not very sure
% why it's necessary to permute the data. What
% I'm doing instead at the moment is make sure
% that my MINC files have x,y,z dimension order
% prior to converting them to nrrd
%X = permute(X, [2 1 3]);
